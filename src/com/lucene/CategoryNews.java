...
public class CategoryNews {
	...
	public ArrayList <Document> GenerateCategoryData(Document document, String newsURL) throws IOException, BiffException {

		File file = new File(LuceneConstants.FILE_PATH_CATEGORY);
		...
		for (int i = 0; i < columns0.length; i++) {
			...
			if (value0.equalsIgnoreCase(newsURL)) {
				...
				Field CATEGORY_NEWS = new Field(LuceneConstants.CATEGORY_NEWS, value2, Field.Store.YES,Field.Index.ANALYZED,Field.TermVector.WITH_POSITIONS_OFFSETS);
